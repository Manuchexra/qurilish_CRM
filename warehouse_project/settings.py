...
SECRET_KEY = 'django-insecure-$#u&)hrq&2&7z24uj^+w++1y^zmaq1+api^$66t5j9^ukohqgf'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'manuchehra.pythonanywhere.com',
    'localhost',
    '127.0.0.1',
    'www.manuchehra.pythonanywhere.com'
]
...
# Custom User modelni ko'rsating
